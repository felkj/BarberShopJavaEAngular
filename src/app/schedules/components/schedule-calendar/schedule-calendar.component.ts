...
import { IDialogManegerService } from '../../../services/idialog-manager.service';
...
import { SchedulesMonthComponent } from '../../schedules-month/schedules-month.component';
...
export class ScheduleCalendarComponent implements AfterViewInit, OnChanges , OnInit{
  ...
  constructor(@Inject(SERVICES_TOKEN.DIALOG) private readonly dialogManegerService: IDialogManegerService){}
  ...
  requestDelete(schedule: ClientScheduleAppointmentModel){
    this.subscriptions = this.dialogManegerService.showYesNoDialog(
